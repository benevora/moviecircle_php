...
?>
  ...
  <!-- ========== MAIN CONTENT ========= -->
  <div id="main-container" class="container-fluid edit-profile-page pt-5">
    <div class="row justify-content-center" id="edit-row">
      ...
      ================================ -->
        ...
        <div class="col-md-6" >
          <form action="<?= $BASE_URL ?>user_process.php" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="type" value="updatebio">
            ...
            <!-- SUBMIT BUTTON -->
            <div class="mb-3">
              <input type="submit" class="btn card-btn mt-3" value="Save changes">
            </div>
          </form>
        </div>
